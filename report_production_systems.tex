...
\tiporelatorio{Final}
\nomeprojeto{Sistemas Produtivos Industriais}
...
\begin{acgroupdef}[list=acronyms]
	\acdef{ANEEL}{Agência Nacional de Energia Elétrica}
	\acdef{CEP}{Controle Estatístico de Processos}
	\acdef{CNC}{Controle Numérico Computadorizado}
	\acdef{JIT}{\textit{Just In Time}}
	\acdef{MRP}{\textit{Manufacturing Resource Planning}}
	\acdef{PAP}{Plano Agregado de Produção}
	\acdef{PCP}{Planejamento e Controle da Produção}
	\acdef{QFD}{\textit{Quality Function Deployment}}
	\acdef{TI}{Tecnologia da Informação}
	\acdef{SAP}{Systeme, Anwendungen und Produkte in der Datenverarbeitung}
	%
	%
\end{acgroupdef}
% --------------------------------------------------------------------------
...
% Sumário executivo
	...
	% 	O projeto foi considerado como início técnico do projeto o dia 00 de mês de 2020.
...
% Conteúdo do relatório
	...
	\include{sections/02gestaodasoperacoes}
	% \include{sections/02admprod}
	\include{sections/03medidasdedesempenhodaoperacao}
	\include{sections/04estrategiadaproducao}
	\include{sections/05tipodeprocessodeproducao}
	\include{sections/06projetodoproduto}
	\include{sections/07pnovasinstalacoes}
	\include{sections/08parranjofisico}
	\include{sections/09tecrecurso}
	\include{sections/10introplanejamento}
	\include{sections/11planejamentoagregado}
	\include{sections/12controleestoques}
	\include{sections/13manufacturingresource}
	\include{sections/14fornecimentojit}
	\include{sections/15controleestatistico}
	\include{sections/16confiablidademanutencao}
	\include{sections/17conclusao}
